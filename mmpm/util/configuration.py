...
class Configuration():
    def parse(self, unknown_arg_ok=False):
        ...
        parser.add_argument('--num_workers', help='Total number of dataloader workers across all GPUs processes', type=int, default=0)
        ...
        parser.add_argument('--s0_batch_size', default=4, type=int)
        parser.add_argument('--s0_iterations', default=600000, type=int)
        ...
        parser.add_argument('--s0_start_warm', default=200000, type=int)
        parser.add_argument('--s0_end_warm', default=700000, type=int)
        ...
        parser.add_argument('--s2_batch_size', default=4, type=int)
        ...
        parser.add_argument('--s2_num_ref_frames', default=2, type=int)
        parser.add_argument('--s2_num_frames', default=3, type=int)
        ...
        parser.add_argument('--s3_iterations', default=400000, type=int)
        # fine-tune means fewer augmentations to train the sensory memory
        # parser.add_argument('--s3_finetune', default=0, type=int)
        ...
        parser.add_argument('--s3_num_ref_frames', default=2, type=int)
        parser.add_argument('--s3_num_frames', default=3, type=int)
        parser.add_argument('--s3_start_warm', default=200000000, type=int)
        parser.add_argument('--s3_end_warm', default=200000000, type=int)
        parser.add_argument('--s3_max_num_obj', default=3, type=int)


        # Stage 4, ViSA
        parser.add_argument('--s4_batch_size', default=8, type=int)
        parser.add_argument('--s4_iterations', default=400000, type=int)
        # fine-tune means fewer augmentations to train the sensory memory
        # parser.add_argument('--s3_finetune', default=0, type=int)
        parser.add_argument('--s4_finetune', default=10000, type=int)
        # parser.add_argument('--s4_steps', nargs="*", default=[80000], type=int)
        ...
        parser.add_argument('--s4_start_warm', default=200000000, type=int)
        parser.add_argument('--s4_end_warm', default=200000000, type=int)
        parser.add_argument('--s4_max_num_obj', default=1, type=int)
    ...
    def get_stage_parameters(self, stage):
        ...
        if stage == "4":
            parameters['max_num_obj'] = self.args['s%s_max_num_obj'%stage]
