        ...
        while trials < 5:
            ...
            for f_idx in frames_idx:
                ...
                for anno in annotations:
                    if anno['iou'] < self.iou_threshold:
                        to_filter_iou_id.add(anno_id)  # 아예 Proposal 생성안하도록, Track이 Selct 안되게 함.
            ...
            for fi in range(len(frames_idx)):
                ...
                for anno in annotations:
                    ...
                    if fi == 0:
                        if this_gt[anno_mask == 1].sum() == 0. and anno_mask.sum() > size_thr: # 겹치는 Mask 없도록 함.
                            this_gt[anno_mask == 1] = anno_id + 1
                            annotated_ids.append(anno_id+1)
                            size_thr += 500
                    elif anno_id+1 in annotated_ids:
                        this_gt[anno_mask == 1] = anno_id + 1
